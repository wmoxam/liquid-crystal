...
class StandardFiltersTest < Minitest::Test
  ...
  def initialize(foo)
    super
    @filters = Liquid::StandardFilters.new(nil)
  end
  ...
  def test_size
    ...
    assert_equal 0, @filters.size([] of Int32)
  ...
  def test_first_last
    ...
    assert_equal nil, @filters.first([] of Int32)
    assert_equal nil, @filters.last([] of Int32)
  end
